...
export function EditBlogForm({ blogPost, categories }: EditBlogFormProps) {
  const router = useRouter();
  const [isLoading, setIsLoading] = useState(false);
  const [imagePreview, setImagePreview] = useState<string | null>(blogPost.featuredImage);
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const res = await updateBlogPostAction(blogPost.id, {
        ...data,
