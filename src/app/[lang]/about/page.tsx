...
import { ShieldCheck, Award, Users2, FileText, CheckCircle, Scale } from "lucide-react";
...
export default async function AboutPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const whyTitle1 = dict.about.whyChooseUs.items[0].title;
  const whyDesc1 = dict.about.whyChooseUs.items[0].desc;
  const whyTitle2 = dict.about.whyChooseUs.items[1].title;
  const whyDesc2 = dict.about.whyChooseUs.items[1].desc;
  const whyTitle3 = dict.about.whyChooseUs.items[2].title;
  const whyDesc3 = dict.about.whyChooseUs.items[2].desc;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      {/* 4. Values (Professional, Trust, Quality) */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-sm mt-3 max-w-xl mx-auto">
              {dict.about.whyChooseUs.description}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center mx-auto shadow-md">
                <ShieldCheck className="w-7 h-7" />
              </div>
              <h4 className="text-lg font-bold text-slate-900">{whyTitle1}</h4>
            ...
            <div className="text-center p-6 space-y-4">
              ...
              <h4 className="text-lg font-bold text-slate-900">{whyTitle2}</h4>
              <p className="text-slate-500 text-sm leading-relaxed">
                {whyDesc2}
              </p>
            </div>
            ...
            <div className="text-center p-6 space-y-4">
              ...
              <h4 className="text-lg font-bold text-slate-900">{whyTitle3}</h4>
              <p className="text-slate-500 text-sm leading-relaxed">
                {whyDesc3}
              </p>
            </div>
